...
- В blockquote: столько пунктов через тире, сколько нужно чтобы полно раскрыть новость — если новость маленькая, хватит 1-2, если большая и многофункциональная — можно 5-6. Не растягивай и не сжимай искусственно

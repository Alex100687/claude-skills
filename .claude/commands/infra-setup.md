...
### 4. Troubleshooting
Если пользователь описывает проблему — прочитай `references/infra-troubleshooting.md` и помоги решить.

### 5. Советы и лайфхаки
Если пользователь спрашивает "что ещё полезного?" / "советы" / "лайфхаки" — прочитай `references/infra-insights.md`.
...
9. **При проблемах** — загляни в `references/infra-troubleshooting.md` перед тем как гуглить
10. **Делись инсайтами** — используй `references/infra-insights.md` для практических советов из реального опыта
